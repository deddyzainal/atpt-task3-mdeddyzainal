...
//   await page.getByRole('textbox', { name: 'Name' }).fill('Testing QA');
//   await page.locator('form').filter({ hasText: 'Signup' }).getByPlaceholder('Email Address').click();
//   await page.locator('form').filter({ hasText: 'Signup' }).getByPlaceholder('Email Address').fill('testingqa123@gmail.com');
//   await page.getByRole('button', { name: 'Signup' }).click();
//   await page.getByRole('radio', { name: 'Mr.' }).check();
...
//   await page.getByRole('textbox', { name: 'First name *' }).fill('Testing Registration');
//   await page.getByRole('textbox', { name: 'Last name *' }).click();
//   await page.getByRole('textbox', { name: 'Last name *' }).fill('Q');
//   await page.getByRole('textbox', { name: 'Last name *' }).click();
...
//   await page.getByRole('textbox', { name: 'Company', exact: true }).fill('Fintopia');
//   await page.getByRole('textbox', { name: 'Address * (Street address, P.' }).click();
//   await page.getByRole('textbox', { name: 'Address * (Street address, P.' }).fill('Mega kuningan timur street');
//   await page.getByRole('textbox', { name: 'Address 2' }).click();
//   await page.getByRole('textbox', { name: 'Address 2' }).fill('Setiabudi street');
//   await page.getByLabel('Country *').selectOption('Singapore');
//   await page.getByRole('textbox', { name: 'State *' }).click();
//   await page.getByRole('textbox', { name: 'State *' }).fill('Singapore');
...
//   await page.getByRole('textbox', { name: 'Mobile Number *' }).fill('08127637464');
